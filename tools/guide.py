...
מה החניכים האחראים בודקים במהלך השבוע. הטופס עצמו — docs/טופס שבת.html (tools/form_page.py).
"""
import sys
...
<div class="send">ממלאים את <b>«טופס שבת»</b> בקישור ששלח אורי, ושולחים לו את ההודעה שנוצרת <b>עד שבוע לפני השבת</b>.<br>
