...
_REGION_BANDS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("🟢", ("ירושלים", "מעלה אדומים", "כפר אדומים", "גוש עציון", "אפרת",
            ...
            # Jerusalem institutions — an affiliation alone must place them
            "האוניברסיטה העברית", "העברית בירושלים", "הרטמן", "ון ליר", "שזר",
            "בצלאל", "מכללת הרצוג")),   # not «פרדס» (פרדס חנה) and not «הדר» (a first name)
