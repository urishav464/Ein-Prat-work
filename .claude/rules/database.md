...
**Fourteen tables.** `mishmarim`, `students`, `assignments`, `tasks`, `budget`, `speakers`, `speaker_outreach`, `lessons`, `lesson_speakers`, `logistics_items`, `feedback`, `chat_messages`, `search_cache`, `app_meta`.
