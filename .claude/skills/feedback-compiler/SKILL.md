...
- Statuses are the Hebrew ladder from the work-file template (`⬜ לא פנינו` · `📩 נשלחה פנייה` · `⏳ ממתין לתשובה` · `✅ סגור` · `❌ לא יכול/ה` · `⚠️ בתנאי`) — never English labels like "Do not invite".
