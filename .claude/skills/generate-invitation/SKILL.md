...
- **WhatsApp copy**: short Hebrew text — hook line from the topic, date (both calendars), time from `dm.mishmar_start(mid)` (20:00 unless the instructor moved that evening), location, speaker names with titles rejoined (`dm.display_name`). No contact details of speakers.
