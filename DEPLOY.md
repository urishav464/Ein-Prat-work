...
**חיפוש ברשת חייב להיות מופעל לארגון** — Claude Console → Settings → Privacy. מסך «חיפוש
מרצים» נותן למודל את כלי החיפוש של אנתרופיק (‎$10 ל-1,000 חיפושים, עד 8 לסריקה); אם הוא
כבוי, ה-API מחזיר 400 והמסך אומר «חיפוש ברשת כבוי לארגון הזה» ומציע קישורים ידניים.
